...
const DEFAULT_ITEMS = [
  ...
  { id: 38, source: "IS", category: "Commercial Revenue",              accounts: "450001",                                                                    rule: "FLAG IF", text: "Commercial base rent (450001) is not the same as the prior month, unless there is a new tenant, a tenant vacates, or a rent increase. Accept reasonable explanation; otherwise flag." },
  { id: 39, source: "IS", category: "Commercial Revenue",              accounts: "450006-450007",                                                             rule: "FLAG IF", text: "Commercial reimbursement (450006-450007) is not the same as the prior month, unless there is a new tenant, a tenant vacates, or a rent increase in account 450001. Accept reasonable explanation; otherwise flag." },
